        ...
        <div className="account__page--component">
            <form className="account__page--component--item">
                ...
                <Stack width="full" textAlign="center" margin={'20px 0'}>
                    ...
                    Illo, dolor? Modi quidem culpa nihil temporibus quo nam
                    aliquam voluptas dolorem ducimus! Possimus ea voluptas
                    officia, fuga incidunt ab dolorum aliquam, qui assumenda
                    illo hic eveniet nesciunt consectetur iste deserunt quis
                    laborum suscipit delectus aliquid itaque perferendis
