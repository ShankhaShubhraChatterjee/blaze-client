		...
		<div className="account__page--component">
			<form className="account__page--component--item">
				...
				<Stack width="full" textAlign="center" margin={"20px 0"}>
					...
					Modi quidem culpa nihil temporibus quo nam aliquam voluptas dolorem
					ducimus! Possimus ea voluptas officia, fuga incidunt ab dolorum
					aliquam, qui assumenda illo hic eveniet nesciunt consectetur iste
					deserunt quis laborum suscipit delectus aliquid itaque perferendis
					placeat. Eum, impedit aspernatur?
				</Stack>
				<PopoverRoot closeOnInteractOutside>
					...
					<PopoverContent>
						...
						<PopoverBody>
							...
							<Stack width="full" direction="column" marginTop="2">
								<InputGroup flex="1" startElement={<LuUser />}>
									<Input placeholder="Type Username ..." />
								</InputGroup>
								<Button colorPalette="red" width="full" disabled>
									Delete Permanently
								</Button>
							</Stack>
						</PopoverBody>
